...
object AppConfig {
    ...
    /** ByeDPI runtime settings migrated from Project-X. */
    ...
    const val APP_URL = "$GITHUB_URL/anonymouskeys/Monster-VPN"
    const val APP_API_URL = "https://api.github.com/repos/anonymouskeys/Monster-VPN/releases"
    ...
    const val TG_CHANNEL_URL = "https://t.me/anonymouskeys"
